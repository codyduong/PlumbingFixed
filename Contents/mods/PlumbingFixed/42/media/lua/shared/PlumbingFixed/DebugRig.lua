...
--- Attach a built thumpable to its square the way ISBuildIsoEntity:create does: add,
...
--- @param y integer
--- @param z integer
--- @param plumbed boolean plumb the sink (false = vanilla-behaving control rig)
--- @return IsoThumpable[] barrels the 4 barrels on the floor above the sink
function PFDebugRig.build(x, y, z, plumbed)
  DebugLog.log(
    DebugType.Mod,
    "PlumbingFixed (PFDebugRig.build) at " .. x .. "," .. y .. "," .. z .. " plumbed=" .. tostring(plumbed)
  )
